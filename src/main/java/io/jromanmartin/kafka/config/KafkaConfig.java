...
public class KafkaConfig {
    ...
    @ConfigProperty(name = "kafka.security.protocol", defaultValue = "security-protocol-undefined")
    String kafkaSecurityProtocol;

    @ConfigProperty(name = "kafka.sasl.mechanism", defaultValue = "sasl-mechanism-undefined")
    String kafkaSaslMechanism;

    @ConfigProperty(name = "rhoas.service-account.clientID", defaultValue = "oauth-client-id-undefined")
    String oauthClientId;

    @ConfigProperty(name = "rhoas.service-account.clientSecret", defaultValue = "oauth-client-secret-undefined")
    String oauthClientSecret;

    @ConfigProperty(name = "rhoas.service-account.oauthTokenUrl", defaultValue = "oauth-token-endpoint-uri-undefined")
    ...
    @ConfigProperty(name = "apicurio.registry.url", defaultValue = "http://localhost:8080/apis/registry/v2")
    ...
    private void loadSecurity(Properties props) {
        // Kafka Security
        ...
        // Apicurio Security
        props.put(SerdeConfig.AUTH_TOKEN_ENDPOINT, oauthTokenEndpointUri);
        props.put(SerdeConfig.AUTH_CLIENT_ID, oauthClientId);
        props.put(SerdeConfig.AUTH_CLIENT_SECRET, oauthClientSecret);
    }
    ...
    public Producer<String, Message> createProducer() {
        ...
        // Set up the resolver to use an exact version of the artifact
        props.putIfAbsent(SerdeConfig.EXPLICIT_ARTIFACT_VERSION, "2.0");

        // Auto-register Artifact into Service Registry
        // If you are using POJO classes generated by avro maven plug-in, then
